    ...
    : IEmployeeLinks
{
    ...
    {
        return dataShaper.ShapeData(employeesDto, fields)
            .Select(e => e.Entity)
            .ToList();
    }
    ...
    private List<Link> CreateLinksForEmployee(HttpContext httpContext, Guid companyId, Guid id, string fields = "")
    {
        ...
        {
            new(
                linkGenerator.GetUriByAction(httpContext, "GetEmployeeForCompany",
            ...
            new(linkGenerator.GetUriByAction(httpContext, "UpdateEmployeeForCompany", values: new { companyId, id }),
                ...
                "PUT"),
            new(
                linkGenerator.GetUriByAction(httpContext, "PartiallyUpdateEmployeeForCompany",
        ...
        LinkCollectionWrapper<Entity> employeesWrapper)
    {
        employeesWrapper.Links.Add(new Link(
            linkGenerator.GetUriByAction(httpContext, "GetEmployeesForCompany", values: new { }),
            "self",
            "GET"));
